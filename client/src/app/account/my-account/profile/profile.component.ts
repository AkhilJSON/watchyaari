...
export class ProfileComponent implements OnInit {
    ...
    updateProfile() {
        ...
        this.profile.updateProfile(this.profileForm.value).subscribe((response: any) => {
    ...
    updatePassword() {
        ...
        this.profile.updateProfile(data).subscribe((response: any) => {
            this.updatingData = false;
            if (response.Success) {
                this.openSnackBar(`Password Changed successfully, Please Login again`, "", "bottom", "center");
