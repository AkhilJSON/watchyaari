...
router.post('/getUserDetails', passport.authenticate('user', {
    session: false
}), commonController.getUserDetails);

router.post('/getChatHistory', passport.authenticate('user', {
    session: false
}), chatController.getChatHistory);


router.post('/joinParty', passport.authenticate('user', {
    session: false
}), partyController.joinParty);


router.post('/getRPrtyList', passport.authenticate('user', {
    session: false
}), partyController.getRecentPartyList);

router.post('/getUPrtyList', passport.authenticate('user', {
    session: false
}), partyController.getUpcomingPartyList);

router.post('/tglePrtPrvcy', passport.authenticate('user', {
    session: false
}), partyController.togglePartyPrivacy);

router.post('/fetchUsrs', passport.authenticate('user', {
    session: false
}), partyController.fetchUsers);

router.post('/fetchBlckdUsrs', passport.authenticate('user', {
    session: false
}), partyController.fetchBlockedUsers);

router.post('/unBlckUsrs', passport.authenticate('user', {
    session: false
}), partyController.unBlockUsers);

router.post('/updCohs', passport.authenticate('user', {
    session: false
...
router.post('/updateVideoInTheParty', passport.authenticate('user', {
    session: false
}), partyController.updateVideoInTheParty);

router.post('/inviteGuestsInTheParty', passport.authenticate('user', {
    session: false
